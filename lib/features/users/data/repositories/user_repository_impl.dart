...
class UserRepositoryImpl extends UserRepository {
  ...
  UserDetailsEntity _mapUserDetailToEntity(UserDetails user) {
    return UserDetailsEntity(
      ...
      fatherAcceptMarriageWithoutQaima: user.profile.fatherAcceptMarriageWithoutQaima,
      fatherKnowAboutThisWebsite: user.profile.fatherKnowAboutThisWebsite,
      youAcceptMarriageWithoutQaima: user.profile.youAcceptMarriageWithoutQaima,
